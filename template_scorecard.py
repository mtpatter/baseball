...
BATTER_SVG_HEADER_SUMMARY = (
    ...
    '<line x1="44" y1="0" x2="44" y2="266" stroke="darkgrey" fill="transparent"/>'
    '<line x1="88" y1="0" x2="88" y2="266" stroke="darkgrey" fill="transparent"/>'
    '<line x1="133" y1="0" x2="133" y2="266" stroke="darkgrey" fill="transparent"/>'
    '<line x1="177" y1="0" x2="177" y2="266" stroke="darkgrey" fill="transparent"/>'
    '<line x1="222" y1="0" x2="222" y2="266" stroke="darkgrey" fill="transparent"/>'
...
SVG_HEADER = (
    ...
    # Balls and strikes
    '<circle cx="20" cy="17" '
    'r="12" stroke="lightgrey" stroke-width="2" fill="white"/>'
    '<circle cx="20" cy="45" '
    'r="12" stroke="lightgrey" stroke-width="2" fill="white"/>'
    #'<circle cx="20" cy="85" '
    ...
    # '<rect x="3" y="3" width="30" height="30" stroke="darkgrey" fill="white" '
    # 'stroke-width="2"/>'
    # '<rect x="33" y="3" width="30" height="30" stroke="darkgrey" fill="white" '
    # 'stroke-width="2"/>'
    # '<rect x="63" y="3" width="30" height="30" stroke="darkgrey" fill="transparent" '
    # 'stroke-width="2"/>'
    # '<rect x="3" y="33" width="30" height="30" stroke="darkgrey" fill="white" '
    # 'stroke-width="2"/>'
    # '<rect x="33" y="33" width="30" height="30" stroke="darkgrey" fill="white" '
    # 'stroke-width="2"/>'
